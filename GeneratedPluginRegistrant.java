...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new io.adtrace.sdk.flutter.AdTraceSdk());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin adtrace_sdk_flutter, io.adtrace.sdk.flutter.AdTraceSdk", e);
    }
    try {
